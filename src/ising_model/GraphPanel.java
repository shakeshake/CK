...
//    private int heigth = 400;
    private int padding = 20;  // margin on each side... 
    private int labelPadding = 25;   // margin on axis side...
    private Color lineColor = new Color(47, 79, 169, 180); //(44,102,230,180)
    private Color pointColor = new Color(100, 100, 100, 180);
    private Color gridColor = new Color(200, 200, 200, 200);
//    private Color bgColor = new Color (255,255,255,220);
...
//        g2.setBackground(bgColor);
        ...
        // create Title Text
        // g2.drawString(graphTitle, padding + labelPadding, padding - 5);  // Left align
        //
        g2.drawString(graphTitle, getWidth() - padding - graphTitle.length()*6, padding - 5);   // Right align
        ...
        for (int i = 0; i < plotdata.size()+1; i++) {
            if (plotdata.size() > 1) {
                ...
                if ((i % ((int) ((plotdata.size() / 10.0)) + 1)) == 0) {
                //if ((i % 100 ) == 0) {    
                    g2.setColor(gridColor);
